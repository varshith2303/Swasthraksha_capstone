...
import { of } from 'rxjs';
import { PolicyApplyComponent } from './policy-apply.component';
import { UserService } from '../../services/user.service';

describe('PolicyApplyComponent', () => {
  let component: PolicyApplyComponent;
  let fixture: ComponentFixture<PolicyApplyComponent>;
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      imports: [PolicyApplyComponent],
      providers: [{ provide: UserService, useValue: userServiceMock }]
    });

    fixture = TestBed.createComponent(PolicyApplyComponent);
