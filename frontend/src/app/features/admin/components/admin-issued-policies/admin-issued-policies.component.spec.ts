...
import { of } from 'rxjs';
import { AdminIssuedPoliciesComponent } from './admin-issued-policies.component';
import { AdminService } from '../../services/admin.service';

describe('AdminIssuedPoliciesComponent', () => {
  let component: AdminIssuedPoliciesComponent;
  let fixture: ComponentFixture<AdminIssuedPoliciesComponent>;
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      imports: [AdminIssuedPoliciesComponent],
      providers: [{ provide: AdminService, useValue: adminServiceMock }]
    });

    fixture = TestBed.createComponent(AdminIssuedPoliciesComponent);
