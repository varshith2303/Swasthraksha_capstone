...
import { of } from 'rxjs';
import { AdminUnderwritersComponent } from './admin-underwriters.component';
import { AdminService } from '../../services/admin.service';

describe('AdminUnderwritersComponent', () => {
  let component: AdminUnderwritersComponent;
  let fixture: ComponentFixture<AdminUnderwritersComponent>;
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      imports: [AdminUnderwritersComponent],
      providers: [{ provide: AdminService, useValue: adminServiceMock }]
    });

    fixture = TestBed.createComponent(AdminUnderwritersComponent);
